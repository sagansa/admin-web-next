      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600">Kelola pengajuan cuti/izin beserta approval</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="start_date_asc">Mulai Naik</option>
              <option value="start_date_desc">Mulai Turun</option>
              <option value="duration_asc">Durasi Naik</option>
              <option value="duration_desc">Durasi Turun</option>
            </select>
          </div>
        </div>
