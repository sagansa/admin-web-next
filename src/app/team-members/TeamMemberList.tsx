    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-3xl font-bold text-gray-900">Team Members</h3>
                    <p className="mt-1 text-sm text-gray-700">
                        Manage team member roles and permissions for your organization.
                    </p>
                </div>
                {isAdmin && (
                    <Button onClick={() => setShowAddModal(true)} aria-label="Add Team Member" title="Add Team Member">
            ...
            <ConfirmationDialog
                ...
                message={`Are you sure you want to remove "${memberToRemove?.name}" from your team? This will revoke their access but will not delete their account.`}
